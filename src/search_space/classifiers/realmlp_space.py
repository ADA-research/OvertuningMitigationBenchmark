...
class RealMLPSpace(BaseComponentSpace):
    ...
    Speed results for search space:
    LR from to (2e-3, 3e-1): 3:11 - 3:38 (conclusion, stick to paper)
    Added all embedding types: 3:38 - 3:00 (conclusion, stick to paper)
    Activation added mish: 3:00 - 2:50 (conclusion, stick to paper)
    [64] * 5 added back: 2:50 - 3:03 (conclusion, okay? but stick to paper for now)
    turned off es: 3:03 - > 9:00 (conclusion, we will keep using early stopping)
    """
