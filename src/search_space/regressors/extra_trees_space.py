"""
Extra Trees Regressor Space Configuration.

This module defines the `ExtraTreesRegressorSpace` class, which is responsible
for constructing the hyperparameter search space for the ExtraTreesRegressor
model using ConfigSpace. All hyperparameters added to this space
are conditional on the model being set to 'ExtraTreesRegressor'.

Classes:
    - ExtraTreesRegressorSpace: Constructs the hyperparameter space for ExtraTreesRegressor.
"""
...
class ExtraTreesSpace(BaseComponentSpace):
    """
    Defines the configuration space for the ExtraTreesRegressor model.

    This class builds the search space for fitting an ExtraTreesRegressor model
    ...
    def __init__(self, component_hp, seed=0):
        """
        Initializes the ExtraTreesRegressor hyperparameter search space.

        Args:
            component_hp (ConfigSpace.hyperparameter.Hyperparameter):
                The top-level hyperparameter selector that identifies the model
                type (e.g., 'ExtraTreesRegressor').
        """
        ...
        # # Add hyperparameters specific to ExtraTreesRegressor
        # self.add_hyperparameters((
        #     ConfigSpace.UniformIntegerHyperparameter(
