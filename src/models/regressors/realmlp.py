...
Question: Can we use the TD? Are the defaults not tuned on some of the TabArena datasets? What does TabArena do?
...
Question: How to do the CV ourselves? Should/can we do that? We do not have gpu to our disposal of course
...
class RealMLPRegressorModel(BaseComponent):
    def __init__(self):
    ...
    def construct(self, config):
        ...
        hidden_size_choices = [[256] * 3, [64] * 5, [512]]
        ...
        return RealMLP_TD_Regressor(
            ...
            random_state=self.config[f"random_state"],
            verbosity=0,
